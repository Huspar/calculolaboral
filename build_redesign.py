...
INDICATOR_BAR_HTML = """
    ...
    <div class="max-w-[1200px] mx-auto px-6 mt-4 mb-8 no-print">
        ...
        <div class="flex justify-between items-center mt-2.5 px-1 text-[10px] text-slate-500 font-medium">
            <div id="indicators-status" class="flex items-center gap-1.5 text-slate-500">
                <span class="material-icons text-[13px] text-emerald-500">check_circle</span> Valores oficiales vigentes (Banco Central de Chile)
            </div>
...
<div class="max-w-[1200px] mx-auto px-6">
    ...
    <div id="finiquito-calc-container" class="flex flex-col lg:flex-row gap-8 items-start">
        <!-- Inputs Column (Left, 440px) -->
        <div class="w-full lg:w-[440px] shrink-0 bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm no-print">
            <div class="flex justify-between items-center mb-5 pb-3 border-b border-slate-100">
                <div>
                    <h2 class="text-lg font-bold text-slate-900">Datos de tu Finiquito</h2>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="space-y-1">
                        ...
                        <input id="startDate" class="block w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-800 focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all outline-none text-xs sm:text-sm font-medium" type="date">
                    </div>
                    <div class="space-y-1">
                        ...
                        <input id="endDate" class="block w-full px-3 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-800 focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all outline-none text-xs sm:text-sm font-medium" type="date">
                    </div>
                </div>

                <!-- Chips de Antigüedad Rápida (1 toque) -->
                <div class="space-y-1 bg-slate-50 p-2.5 rounded-xl border border-slate-200/70">
                    <span class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 ml-0.5">Antigüedad rápida:</span>
                    <div class="grid grid-cols-4 gap-1.5">
                        <button type="button" data-years="1" class="btn-preset-year py-1 px-1.5 bg-white hover:bg-sky-50 border border-slate-200 hover:border-sky-300 rounded-lg text-slate-700 hover:text-sky-700 text-xs font-bold transition-all text-center active:scale-95 duration-100 shadow-xs">1 año</button>
                        <button type="button" data-years="2" class="btn-preset-year py-1 px-1.5 bg-white hover:bg-sky-50 border border-slate-200 hover:border-sky-300 rounded-lg text-slate-700 hover:text-sky-700 text-xs font-bold transition-all text-center active:scale-95 duration-100 shadow-xs">2 años</button>
                        <button type="button" data-years="3" class="btn-preset-year py-1 px-1.5 bg-white hover:bg-sky-50 border border-slate-200 hover:border-sky-300 rounded-lg text-slate-700 hover:text-sky-700 text-xs font-bold transition-all text-center active:scale-95 duration-100 shadow-xs">3 años</button>
                        <button type="button" data-years="5" class="btn-preset-year py-1 px-1.5 bg-white hover:bg-sky-50 border border-slate-200 hover:border-sky-300 rounded-lg text-slate-700 hover:text-sky-700 text-xs font-bold transition-all text-center active:scale-95 duration-100 shadow-xs">5 años</button>
                    </div>
                </div>
                ...
                <div class="pt-1 flex items-center justify-between">
                    <label class="flex items-center gap-2.5 cursor-pointer group select-none">
                        ...
                        <span class="text-xs font-medium text-slate-600 group-hover:text-slate-900 transition-colors">¿Te avisaron por escrito con 30 días de anticipación?</span>
                    </label>
                </div>
            </div>

            <!-- BLOQUE 2: SUELDO Y VACACIONES -->
            <div class="pt-5 mt-5 border-t border-slate-100 space-y-4">
                <div class="space-y-1">
                    <div class="flex justify-between items-center ml-1">
                        <label class="block text-xs font-bold text-slate-600 uppercase">Sueldo Base Mensual</label>
                        <button type="button" id="btnMinSalary" class="text-[10px] font-bold text-sky-600 hover:text-sky-700 bg-sky-50 hover:bg-sky-100 border border-sky-200 px-2 py-0.5 rounded-md transition-colors active:scale-95 duration-100">
                            $553.553 Mínimo 2026
                        </button>
                    </div>
                    <input id="baseSalary" data-type="currency" type="text" inputmode="numeric" pattern="[0-9]*" autocomplete="off" class="block w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 font-bold focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all outline-none text-base font-mono text-right" placeholder="$ 0">
                    <span class="block text-[11px] text-slate-400 font-medium ml-1">Monto fijo en tu contrato antes de descuentos legales.</span>
                </div>

                <div class="space-y-1">
                    <div class="flex justify-between items-center ml-1">
                        <label class="block text-xs font-bold text-slate-600 uppercase">Gratificación Legal Mensual</label>
                        <span class="text-[10px] font-semibold text-sky-600 bg-sky-50 px-2 py-0.5 rounded-full">Art. 50 (25% tope)</span>
                    </div>
                    <input id="gratification" data-type="currency" type="text" inputmode="numeric" pattern="[0-9]*" autocomplete="off" class="block w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-700 font-bold outline-none text-sm font-mono text-right" placeholder="$ 0">
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <span class="block text-[11px] text-slate-400 font-medium ml-1">Si no sabes cuántas te deben, déjalo en 0 (la calculadora sumará automáticamente las proporcionales).</span>
                </div>
            </div>

            <!-- BLOQUE 3: OPCIONES AVANZADAS (ACORDEÓN COLAPSABLE) -->
            <div class="pt-4 mt-5 border-t border-slate-100">
                <button type="button" id="btnToggleAdvanced" class="w-full flex justify-between items-center py-2.5 px-3.5 bg-slate-50 hover:bg-slate-100/80 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 transition-all group select-none">
                ...
                <div id="containerAdvancedOptions" class="hidden mt-3 space-y-4 pt-1">
                    <!-- Asignaciones no imponibles -->
                    <div class="space-y-1">
                        <label class="block text-xs font-bold text-slate-600 uppercase ml-1">Asignaciones Fijas (Colación/Movilización)</label>
                        <input id="assignments" data-type="currency" type="text" inputmode="numeric" pattern="[0-9]*" autocomplete="off" class="block w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-800 font-bold focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all outline-none text-sm font-mono text-right" placeholder="$ 0">
                        <div class="pt-1">
                    ...
                    <div id="variableSalaryContainer" class="hidden space-y-2.5 p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                    ...
                    <div class="space-y-2 pt-2 border-t border-slate-100">
                        <label class="flex items-start gap-2.5 cursor-pointer text-xs select-none">
                            <input id="enableIAS" class="w-4 h-4 rounded border-slate-300 text-sky-500 focus:ring-sky-500 mt-0.5" type="checkbox" checked />
                            <span class="text-slate-600"><strong>Años de Servicio (IAS):</strong> 1 sueldo por año trabajado (tope 11).</span>
                        </label>
                        <label class="flex items-start gap-2.5 cursor-pointer text-xs select-none">
                            <input id="enableNotice" class="w-4 h-4 rounded border-slate-300 text-sky-500 focus:ring-sky-500 mt-0.5" type="checkbox" checked />
                            <span class="text-slate-600"><strong>Indemnización Aviso Previo:</strong> 1 sueldo si no hubo 30 días de aviso.</span>
                        </label>
                        <label class="flex items-start gap-2.5 cursor-pointer text-xs select-none">
                            <input id="simulateAFC" class="w-4 h-4 rounded border-slate-300 text-sky-500 focus:ring-sky-500 mt-0.5" type="checkbox" checked />
                            <span class="text-slate-600"><strong>Descontar Aporte Empleador AFC:</strong> Seguro de cesantía (solo Art. 161).</span>
                        </label>
                        <label class="flex items-start gap-2.5 cursor-pointer text-xs select-none">
                            <input id="enablePending" class="w-4 h-4 rounded border-slate-300 text-sky-500 focus:ring-sky-500 mt-0.5" type="checkbox" checked />
                            <span class="text-slate-600"><strong>Días Trabajados en el Mes:</strong> Remuneración del mes de salida.</span>
                        </label>
                        <label class="flex items-start gap-2.5 cursor-pointer text-xs select-none">
                            <input id="includeAssignmentsInIndemnity" class="w-4 h-4 rounded border-slate-300 text-sky-500 focus:ring-sky-500 mt-0.5" type="checkbox" checked />
                            <span class="text-slate-600"><strong>Incluir Asignaciones en Base Diaria:</strong> Criterio judicial colación/mov.</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-5 lg:hidden">
                <button type="button" id="btnScrollToResults" class="w-full py-3 px-4 bg-sky-500 hover:bg-sky-600 text-white font-bold rounded-2xl text-sm shadow-md shadow-sky-500/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-all">
        ...
        <div id="resultados-finiquito" class="flex-grow bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm lg:sticky lg:top-24 space-y-6 scroll-mt-20">
            ...
            <div id="lead-section" class="mt-4 p-5 bg-gradient-to-br from-amber-50 to-amber-100/40 border-2 border-amber-300 rounded-2xl no-print hidden shadow-sm space-y-3">
              ...
              <div>
                <h4 id="lead-title" class="text-sm font-bold text-slate-900 leading-snug">
                  ¿Dudas sobre el cálculo o causal de tu despido?
                </h4>
                <p id="lead-desc" class="text-xs text-slate-600 mt-1 leading-relaxed">
              ...
              <form id="lead-form" class="space-y-2 pt-1" onsubmit="event.preventDefault(); enviarLead();">
...
INDEX_SCRIPTS = """
    ...
    <script src="/js/ui.js?v=2.0.8"></script>
    <script>
